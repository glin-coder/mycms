...
class Home extends M_Controller {
    ...
    public function clear_init() {


        $this->db->query('TRUNCATE TABLE `'.$this->db->dbprefix('1_book').'`');
        $this->db->query('TRUNCATE TABLE `'.$this->db->dbprefix('1_book_comment_index').'`');
        $this->db->query('TRUNCATE TABLE `'.$this->db->dbprefix('1_book_data_0').'`');
        $this->db->query('TRUNCATE TABLE `'.$this->db->dbprefix('1_book_extend').'`');
        $this->db->query('TRUNCATE TABLE `'.$this->db->dbprefix('1_book_extend_data_0').'`');
        $this->db->query('TRUNCATE TABLE `'.$this->db->dbprefix('1_book_extend_index').'`');
        $this->db->query('TRUNCATE TABLE `'.$this->db->dbprefix('1_book_index').'`');
        $this->db->query('TRUNCATE TABLE `'.$this->db->dbprefix('1_demo').'`');
        $this->db->query('TRUNCATE TABLE `'.$this->db->dbprefix('1_demo_index').'`');
        $this->db->query('TRUNCATE TABLE `'.$this->db->dbprefix('1_demo_data_0').'`');
        $this->db->query('TRUNCATE TABLE `'.$this->db->dbprefix('1_down').'`');
        $this->db->query('TRUNCATE TABLE `'.$this->db->dbprefix('1_down_index').'`');
        $this->db->query('TRUNCATE TABLE `'.$this->db->dbprefix('1_down_data_0').'`');
        $this->db->query('TRUNCATE TABLE `'.$this->db->dbprefix('1_news').'`');
        $this->db->query('TRUNCATE TABLE `'.$this->db->dbprefix('1_news_index').'`');
        $this->db->query('TRUNCATE TABLE `'.$this->db->dbprefix('1_news_data_0').'`');
        $this->db->query('TRUNCATE TABLE `'.$this->db->dbprefix('1_share_category').'`');
        $this->db->query('TRUNCATE TABLE `'.$this->db->dbprefix('1_share_index').'`');
        $this->db->query('TRUNCATE TABLE `'.$this->db->dbprefix('1_share_extend_index').'`');
        $this->update_cache_post();
        @unlink(WEBPATH.'cache/install.data');
        echo dr_json(1, "操作成功");exit;
    }

    public function close_init() {
        @unlink(WEBPATH.'cache/install.data');
        exit;
    }
}